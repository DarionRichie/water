/*
 * @Author: your name
 * @Date: 2021-04-09 14:31:10
 * @LastEditTime: 2021-04-09 14:58:59
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: /water_contains/routes/denote.js
 */
...
router.get('/getMynote',function(req,res,next){
    ...
    MongoClient.connect(_url, function (err, db) {
        ...
        dbo.collection("denote_info").find({denoteEr_id:parseObj.query.id}).toArray(function (err, result) {
            if (err) throw err;
...
router.post('/add_Denote',function(req,res,next){
    var MongoClient = require('mongodb').MongoClient;
    var url = "mongodb://121.4.18.254:27017/";
    var isRegister = false;
    MongoClient.connect(url, function (err, db) {
        ...
        // var myobj = { name: "lizhitao", url: "www.runoob" };
        console.log(req.body)
        dbo.collection("denote_info").insertOne(req.body,function(err,res){
            if (err) throw err;
            console.log("插入成功");
            db.close();
        })
